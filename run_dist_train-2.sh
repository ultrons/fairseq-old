...
python train.py /home/jupyter/data/wmt18_en_de_bpej32k \
...
--max-update 10000 --seed 3 --save-interval-updates 16000 \
...
--distributed-port 12597 --distributed-world-size ${WORLD_SIZE} \
--distributed-init-method 'tcp://10.138.0.6:8085' --distributed-rank $RANK \
